...
function smartmonkey_load_scripts()
{
    ...
    wp_enqueue_style('open-sans', '//fonts.googleapis.com/css?family=Open+Sans:400,700',false,false,'all');
    wp_enqueue_style( 'main', get_template_directory_uri().'/css/main.css', false, false, 'all' );

	// Scripts
    wp_enqueue_script('jq','//ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js',array(),'1',true);
